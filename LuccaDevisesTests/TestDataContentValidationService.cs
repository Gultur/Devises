...
public class TestDataContentValidationService
{
    ...
    [TestCase("10.5")]
    [TestCase("10,5")]
    public void DataContentValidationService_IsDataContentValid_When_Header_Invalid_Amount_Then_Return_Failure(string amount)
    {
        // Arrange
        string[] dataContent = this.GetValidData();
    ...
    [Test]
    public void DataContentValidationService_IsDataContentValid_When_Header_Invalid_Currency_Then_Return_Failure()
    {
        // Arrange
        string[] dataContent = this.GetValidData();
    ...
    [TestCase("")]
    [TestCase("-5")]
    public void DataContentValidationService_IsDataContentValid_When_ExchangeRates_LinesCount_InvalidType_Then_Return_Failure(string lineCount)
    {
        // Arrange
        string[] dataContent = this.GetValidData();
    ...
    [Test]
    public void DataContentValidationService_IsDataContentValid_When_ExchangeRates_LinesCount_InvalidNumber_Then_Return_Failure()
    {
        // Arrange
        string[] dataContent = this.GetValidData();
    ...
    [Test]
    public void DataContentValidationService_IsDataContentValid_When_ExchangeRates_InvalidLine_Then_Return_Failure()
    {
        // Arrange
        string[] dataContent = this.GetValidData();
    ...
    public void DataContentValidationService_IsDataContentValid_When_ExchangeRates_InvalidLine_Then_Return_Failure(string lineElement)
    {
        // Arrange
        // Arrange
        string[] dataContent = this.GetValidData();
